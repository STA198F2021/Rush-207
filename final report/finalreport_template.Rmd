...
ggplot(data = heart_grouped4)+
  geom_bar(mapping = aes(x = press_level, fill = ChestPainType), position = "dodge")+
...
ggplot(data = heart_grouped4)+ #need to change x labels from 0-1 to male-female
  geom_bar(mapping = aes(x = as.factor(sex_factor), fill = ChestPainType), position = "dodge")+
  labs(title = "Type of Chest Pain by Sex", x= "Sex", y = "Count", fill = "Chest Pain Type")

ggplot(data = heart_grouped4)+
geom_bar(mapping = aes(x = as.factor(exer_factor), fill = ChestPainType), position = "dodge")+
...
ggplot(data = heart_grouped)+
  geom_bar(mapping = aes(x = as.factor(HeartDisease), fill = ChestPainType), position = "dodge")+
